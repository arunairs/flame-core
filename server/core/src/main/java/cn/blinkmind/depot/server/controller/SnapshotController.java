...
public class SnapshotController
{
	...
	@Token
	@GetMapping(path = "workspace/snapshots")
	public ResponseEntity<Snapshot> get(@RequestParam(name = "branchId") long branchId, @RequestAttribute(name = "user") User user)
	{
	...
	@Token
	@PutMapping(path = "workspace/snapshots")
	public ResponseEntity<Void> update(@RequestParam(name = "branchId") long branchId, @RequestBody Snapshot snapshot, @RequestAttribute(name = "user") User user)
	{
